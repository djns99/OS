...
void init_idt()
{
    const typeof( &isr0 ) isr_funcs[32] = { &isr0, &isr1, &isr2, &isr3, &isr4, &isr5, &isr6, &isr7, &isr8, &isr9,
    ...
    memset8( idt, 0x0, sizeof( idt ) );
    memset8( irq_handlers, 0x0, sizeof( irq_handlers ) );
